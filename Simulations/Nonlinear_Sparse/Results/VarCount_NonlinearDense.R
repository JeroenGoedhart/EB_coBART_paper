...
setwd("C:/Users/jeroen/Desktop/EB_coBART_paper/Simulations/Nonlinear_Sparse")
setwd("C:/Users/jeroen/Desktop/EB_coBART_paper/Simulations/Linear_Dense")
...
remove(results,waic,EstProbs)
### compute est. probs for EBcoBART
#load("Results/Friedman_20_100_2_0.95_2_EBBart_WAIC_Final.Rdata")
#load("Results/Friedman_20_100_1_0.1_4_EBBart_WAIC_Final.Rdata")

load("Results/LinearDense1_100_1_0.1_4_EBBart_WAIC.Rdata")
GroupProbs <- results$GroupProbs
waic <- results$WAIC
remove(results); gc()
minima = apply(waic,1, function (x) which.min(x)) # WAIC minimum
minima
